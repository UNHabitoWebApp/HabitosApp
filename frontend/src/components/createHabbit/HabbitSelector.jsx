        ...
        screen !== "feedback" && (
          <div className="flex flex-col items-center mt-5 p-3 bg-[#ADD9C5] border-2 border-[#5F936C] rounded-[20px] w-full max-w-md">
            ...
            <div className="flex gap-10 mt-1">
              <button
                className={`flex items-center gap-1 min-w-[120px] px-3 py-1 text-white text-sm rounded-[20px] transition-all duration-300 ${screen === "personalizedForm"
                  ? "bg-[#569788]"
                  : "bg-[#84A59D]"
                  }`}
              ...
              <button
                className={`flex items-center min-w-[120px] px-3 py-1 text-white text-sm rounded-[20px] transition-all duration-300 ${screen === "routineForm"
                  ? "bg-[#569788]"
                  : "bg-[#84A59D]"
                  }`}
